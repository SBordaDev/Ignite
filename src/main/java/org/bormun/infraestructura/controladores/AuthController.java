...
import org.bormun.aplicacion.dto.request.LoginRequestDTO;
import org.bormun.aplicacion.dto.request.RegistroRequestDTO;
import org.bormun.aplicacion.dto.response.TokenResponseDTO;
...
public class AuthController {
    ...
    public ResponseEntity<?> registrarUsuario(@Valid @RequestBody RegistroRequestDTO dto) {
        ...
        UsuarioEntidad nuevoUsuario = new UsuarioEntidad(dto.email(), contrasenaEncriptada, dto.rol());
